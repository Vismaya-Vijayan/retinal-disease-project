...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--output_graph',
        type=str,
        default='logs_d/output_graph.pb',
        help='Where to save the trained graph.'
        )
    parser.add_argument(
        '--output_labels',
        type=str,
        default='logs_d/output_labels.txt',
        help='Where to save the trained graph\'s labels.'
        )
    parser.add_argument(
        '--summaries_dir',
        type=str,
        default='logs_d/retrain_logs',
        help='Where to save summary logs_glaucoma for TensorBoard.'
        )
    parser.add_argument(
    ...
    parser.add_argument(
        '--model_dir',
        type=str,
        default='logs_glaucoma/imagenet',
        help="""\
